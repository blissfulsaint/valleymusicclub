...
export default function LoadingSpinner() {
    return (
        <div role="status" className="flex justify-center">
            <svg aria-hidden="true" className="w-7 h-7 text-slate-400 animate-spin dark:text-slate-400 fill-primaryColor" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
